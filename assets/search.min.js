(function($) {
  ...
  var LunrSearch = (function() {
    ...
    LunrSearch.prototype.displayResults = function(entries, query) {
      ...
      if ($('.hf.home').length > 0) {
          $(".hf.home #search-entries-api").prepend($(".search-result-api"));
          $(".hf.home #search-entries-user").prepend($(".search-result-user"));
          if ($(".search-result-user").length === 0) {
            $(".hf.home #search-entries-user").prepend('<p>No results.</p>');
          }
          if ($(".search-result-api").length === 0) {
            $(".hf.home #search-entries-api").prepend('<p>No results.</p>');
          }
      } else {
          if (entries.length === 0) {
             $entries.append('<p>No results.</p>');
          }
      }
      $results.show();
    };
